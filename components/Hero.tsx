...
// import /jsm-logo.png from "../public/"; // Import your image here
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center md:flex-row md:items-start">
          <div className="flex flex-col items-center md:items-start">
             ...
             */}
            <TextGenerateEffect
              words="Turning ideas into flawless web development."
              className="text-center text-[40px] md:text-5xl lg:text-6xl"
            />

            <p className="text-center md:text-left md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
              Hi! I&apos;m Gizework Marye, a Full-Stack Developer based in
              Ethiopia🇪🇹.
            </p>
